...
static fpc_bep_result_t _tx_link(HCP_comm_t *hcp_comm)
{
    ...
    uint32_t * loc = &crc_calc;
    //*(uint32_t*)(hcp_comm->txrx_buffer[pkt->lnk_size + 4]) = crc_calc;
    hcp_comm->txrx_buffer[pkt->lnk_size + 4] = ((uint8_t *) &crc_calc)[0];
    hcp_comm->txrx_buffer[pkt->lnk_size + 5] = ((uint8_t *) &crc_calc)[1];
    hcp_comm->txrx_buffer[pkt->lnk_size + 6] = ((uint8_t *) &crc_calc)[2];
    hcp_comm->txrx_buffer[pkt->lnk_size + 7] = ((uint8_t *) &crc_calc)[3];
